...
export const AuthInterceptor: HttpInterceptorFn = (req, next) => {
  const excludedPattern = /^(http:\/\/localhost:8082\/auth\/[^/]+|http:\/\/fleet-manager-prd\.us-east-2\.elasticbeanstalk\.com|http:\/\/inventory-service-prd\.us-east-2\.elasticbeanstalk\.com)$/;
